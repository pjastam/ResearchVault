...
from feedreader_identity import podcast_cache_ids
from whisper_local import WHISPER_MODEL, transcribe_audio
...
def _load_podcast_cache(url: str) -> dict:
    ...
    Probeert meerdere sleutels: de URL in het Zotero-item komt van elders dan de link
    in de feed en verschilde in de praktijk op het schema (http/https). Zie
    `feedreader_identity.podcast_cache_ids` voor de meting en de afweging.
    """
