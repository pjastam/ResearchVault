...
- `.claude/test_feedreader_server.py` — 11 regressietests op `veilig_pad()`, met letterlijk het pad dat lekte; laadt het script via `importlib` (hyphen in de naam) en draait op kale stdlib, dus mee in de `tests`-workflow
